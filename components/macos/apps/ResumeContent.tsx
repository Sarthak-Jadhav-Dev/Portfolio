...
export const ResumeContent = () => {
    return (
        <div className="h-full w-full bg-white dark:bg-[#1e1e1e] overflow-auto">
            {/* Header */}
            <div className="bg-linear-to-r from-stone-500 to-stone-600 p-6 text-white">
                <div className="flex justify-between items-start">
                    <div>
                        <h1 className="text-3xl font-bold">Sarthak Jadhav</h1>
                        <p className="text-stone-100 mt-1">Full Stack Developer</p>
                    </div>
            ...
            <div className="p-6 space-y-6">
                ...
                <section>
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                        I am a passionate MERN Stack Developer , DEVOPS , and Generative AI . Experience in building modern web applications.
                        Skilled in React, Next.js, Node.js, and cloud technologies. Strong problem-solving
                        abilities and a keen eye for creating intuitive user experiences. Recently Exploring different Areas in Generative AI to build AI based applications.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <div className="space-y-4">
                        <div className="relative pl-6 border-l-2 border-blue-300 dark:border-blue-700">
                            ...
                            <p className="text-sm text-blue-600 dark:text-blue-400">Freelance for Kids Trans EduTech Pvt.Ltd • 2025</p>
                            <ul className="mt-2 text-sm text-gray-600 dark:text-gray-400 list-disc list-inside space-y-1">
                                <li>Developed a web application for Kids Trans EduTech Pvt.Ltd using React and Node.js</li>
                    ...
                    <div className="space-y-4">
                        <div className="relative pl-6 border-l-2 border-blue-300 dark:border-blue-700">
                            <div className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-blue-500" />
                            <h3 className="font-semibold text-gray-900 dark:text-white">Full Stack Developer</h3>
                            <p className="text-sm text-blue-600 dark:text-blue-400">Freelance for CA-MN-Deshmukh and Associates.Ltd • 2025</p>
                            <ul className="mt-2 text-sm text-gray-600 dark:text-gray-400 list-disc list-inside space-y-1">
                                <li>Developed a Website for CA-MN-Deshmukh and Associates.Ltd using React and Node.js</li>
                                <li>Collaborated with cross-functional teams to deliver features and meet company goals and requirements</li>
                            </ul>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2 mb-3 flex items-center gap-2">
                        <FaCertificate className="text-yellow-500" /> Skills
                    </h2>
                    <div className="flex flex-wrap gap-2">
                        {['Generative AI', 'MERN Stack Developer', 'DEVOPS' , 'Python','JavaScript','Next.js', 'Node.js', 'Express.js','React.js', 'Tailwind CSS', 'TypeScript','Git', 'GitHub' , 'AWS' , 'Docker','Kubernetes','Jenkins','LangChain','LangGraphs','NumPy','Pandas'].map((cert) => (
